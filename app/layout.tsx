...
export const metadata: Metadata = {
  title: "Mercer Street Capital | Search Fund",
  description: "Mercer Street Capital is a self-funded search fund seeking to acquire and operate a single, well-managed small to medium-sized business.",
};
